        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('edit.view.kategori', $k->id) }}" class="btn btn-warning">
                            Edit
                        </a>
                    </td>
                </tr>
...
<div class="modal fade" id="addKategoriModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('member.add.kategori') }}" method="POST">
                @csrf
...
<div class="modal fade show" id="editKategoriModal" tabindex="-1" style="display:block; background:rgba(0,0,0,0.4)">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('member.update.kategori') }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="modal-header">
                    ...
                    <a href="{{ route('member.kategori') }}" class="btn-close"></a>
                </div>
                ...
                <div class="modal-footer">
                    <a href="{{ route('member.kategori') }}" class="btn btn-secondary">Tutup</a>
