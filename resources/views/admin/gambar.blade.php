                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                                ...
                                <a href="{{ route('gambar.hapus', $gmbr->id) }}" type="submit" onclick="return confirm('Hapus gambar ini?')" class="btn btn-danger btn-sm w-100">
                                    Hapus
                                </a>
                            {{-- EDIT --}}
                            <button class="btn btn-warning btn-sm w-100" data-bs-toggle="modal" data-bs-target="#editModal{{ $gmbr->id }}">
                                Edit
                            </button>
                        </td>
                    </tr>
                    ...
                    <div class="modal fade" id="editModal{{ $gmbr->id }}" tabindex="-1">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="{{ route('gambar.ubah', $gmbr->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
